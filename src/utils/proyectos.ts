...
export const proyectos = [
        ...
        },
        {
            ...
            descripcionCorta: 'Esta es una tienda virtual que realice como proyecto final en mi formacion en Tokio School, este proyecto tiene como fin la venta de productos electronicos, como tambien el ingreso de mas productos.',
            descripcionCompleta: 'Este proyecto representó mi proyecto final en mi formación en TokioSchool. Desarrollé una tienda virtual utilizando el framework de Python Flask. La aplicación contaba con varios roles, como vendedor, proveedor y administrador. En la tienda, los usuarios pueden ver la cantidad de productos en stock, y si un producto alcanza una cantidad determinada (configurada por el administrador), se envía automáticamente un correo electrónico al proveedor a través de Outlook, notificándole que el producto está casi agotado y solicitando más stock.',
            link: 'https://github.com/Vazquez1240/TiendaVirtual',
