...
export const Presentacion = () => {
    ...
    return (
        <section className=" mx-auto lg:mt-[10%] md:max-w-[85%] sm:max-w-[90%] lg:max-w-[70%] xl:max-w-[70%] sm:mt-[30%]">
            <div className='text-left lg:flex-col lg:justify-center lg:items-center md:gap-x-4 max-w-[100%] '>
                ...
                <span
                    className=" font-semibold inline-flex dark:bg-[linear-gradient(110deg,#b6eaff,45%,#065074,55%,#b6eaff)] bg-[length:250%_100%] bg-clip-text text-xl text-transparent">
                ...
                <div className='sm:max-w-[100%] lg:flex-row lg:mt-8 lg:gap-10 flex sm:flex-col sm:gap-5 sm:mt-2'>
